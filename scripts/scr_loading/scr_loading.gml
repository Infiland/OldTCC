...
//Folders
	...
	directory_destroy(directory + "Skins")
		...
		file_text_close(_f);
			if file_exists(working_directory + "/Custom/Custom Splash Texts.txt") file_delete(working_directory + "/Custom/Custom Splash Texts.txt");
		var _f = file_text_open_write(working_directory + "/Custom/Custom Splash Texts.txt");
	    file_text_write_string(_f, string("Beta 1.8 Feature"));
		file_text_close(_f);
	}
