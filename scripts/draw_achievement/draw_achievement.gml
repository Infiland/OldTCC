...
draw_sprite_ext(s_xpbar,0,x+10,y+95,93*(stat/req),2.4,0,c_red,1)
} else {
draw_sprite_ext(s_xpbar,0,x+10,y+95,93,2.4,0,c_lime,1)	
}} else {
if steam_get_achievement(stat) {
draw_sprite_ext(s_xpbar,0,x+10,y+95,93,2.4,0,c_lime,1)	
} else { draw_sprite_ext(s_xpbar,0,x+10,y+95,93,2.4,0,c_red,1) }
}
