...
break;
case(81): sprite_index = s_doublejumpitem break; //Double Jump Item
...
image_alpha = 0.5
break;	//White Block
case(87): sprite_index = s_redblockbreakable
image_speed = 0.5 break; //Red Block Breakable
case(88): sprite_index = s_yellowblockbreakable
image_speed = 0.5 break; //Yellow Block Breakable
case(89): sprite_index = s_greenblockbreakable
image_speed = 0.5 break; //Green Block Breakable
case(90): sprite_index = s_blueblockbreakable
image_speed = 0.5 break; //Blue Block Breakable
case(91): sprite_index = s_whiteblockbreakable
