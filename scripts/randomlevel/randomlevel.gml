function randomlevel() {
	...
	case(1): global.chooserandomlevel = choose(1,1,2,2,3,14,14,13,20) break;
	case(2): global.chooserandomlevel = choose(1,1,2,2,3,3,14,14,13,13,20) break;
	case(3): global.chooserandomlevel = choose(1,1,2,2,3,3,14,11,13,13,20) break;
	case(4): global.chooserandomlevel = choose(4,2,2,3,3,14,11,7,13,10,20,22,19) break;
	case(5): global.chooserandomlevel = choose(4,2,3,3,16,11,7,13,10,10,15,8,19,19,21,22) break;
	case(6): global.chooserandomlevel = choose(4,5,3,11,7,16,10,9,15,17,15,8,19,21,22) break;
	case(7): global.chooserandomlevel = choose(4,4,5,12,3,7,16,10,9,17,15,8,18,19,21,21,22) break;
	case(8): global.chooserandomlevel = choose(4,5,5,12,7,15,18,9,17,21,23) break;
	case(9): global.chooserandomlevel = choose(5,5,12,6,15,18,15,23) break;
	case(10): global.chooserandomlevel = choose(12,12,6,6,18,23,23,24) break;
	}
	break;
	case(2): 
	if global.endlesslevelhighscore < 50 {
	global.chooserandomlevel = irandom_range(1,23)
	} else {
	global.chooserandomlevel = irandom_range(1,24)
	}
	break;
	case(3):
	CERrandomlevel()
	...
	global.chooserandommusic = irandom_range(1,25)
		} else { CERrandommusic() }
	randomsong()
	audio_stop_all()
