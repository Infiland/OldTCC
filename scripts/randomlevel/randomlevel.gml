function randomlevel() {
	...
	case(2): global.chooserandomlevel = choose(1,1,2,2,3,14,14,13,13,20) break;
	case(3): global.chooserandomlevel = choose(1,2,2,3,3,14,11,13,13,20,25) break;
	case(4): global.chooserandomlevel = choose(4,2,2,3,3,14,11,8,7,13,10,20,22,19,25,27) break;
	case(5): global.chooserandomlevel = choose(4,2,3,16,11,7,13,10,10,15,8,19,19,21,22,25,27) break;
	case(6): global.chooserandomlevel = choose(4,5,11,7,16,10,9,15,17,15,8,19,21,22,27) break;
	case(7): global.chooserandomlevel = choose(4,4,5,12,7,16,10,9,17,15,18,19,21,21,22) break;
