...
if room = r_calendar {
	if instance_exists(o_monthbuttonC) {
	room_goto(r_funmodemenu)
	} else {
	instance_destroy(o_calendarlevel)	
	instance_destroy(o_calendarweekcounter)
	instance_destroy(o_calendarrewardmaker)
	instance_create(x,y,o_calendarmonthmaker)
	}}
