...
if instance_exists(o_player) {
if o_player.y < y - 60 {
if place_meeting(x,y+1,o_redblock) or place_meeting(x,y+1,o_redblockmove) or place_meeting(x,y+1,o_yellowblock) or place_meeting(x,y+1,o_greenblock) or place_meeting(x,y+1,o_blueblock) or place_meeting(x,y+1,o_whiteblock) or place_meeting(x,y+1,o_yellowblockmove) or place_meeting(x,y+1,o_greenblockmove) or place_meeting(x,y+1,o_blueblockmove) or place_meeting(x,y+1,o_whiteblockmove) or place_meeting(x,y+1,o_shooter) or place_meeting(x,y+1,o_shooterright) or place_meeting(x,y+1,o_iceblock) or place_meeting(x,y+1,o_box) or place_meeting(x,y+1,o_boxwithammo) or place_meeting(x,y+1,o_boxwithinfiniteammo){
if !place_meeting(x,y-32,o_redblock) or !place_meeting(x,y-32,o_redblockmove) or !place_meeting(x,y-32,o_yellowblock) or !place_meeting(x,y-32,o_greenblock) or !place_meeting(x,y-32,o_blueblock) or !place_meeting(x,y-32,o_whiteblock) or !place_meeting(x,y-32,o_yellowblockmove) or !place_meeting(x,y-32,o_greenblockmove) or !place_meeting(x,y-32,o_blueblockmove) or !place_meeting(x,y-32,o_whiteblockmove) or !place_meeting(x,y-32,o_shooter) or !place_meeting(x,y-32,o_shooterright) or !place_meeting(x,y-32,o_iceblock) or !place_meeting(x,y-32,o_box) or !place_meeting(x,y-32,o_boxwithinfiniteammo) or !place_meeting(x,y-32,o_boxwithammo){
	jump()
	}}
	}
}}}
