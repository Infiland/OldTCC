...
var col1 = c_orange
var col2 = c_red
if global.creditsmultiplier > 1.49 {
col1 = c_yellow
col2 = c_orange
}
if global.creditsmultiplier > 1.99 {
col1 = c_lime
col2 = c_yellow
}
if global.creditsmultiplier > 2.49 {
col1 = c_aqua
col2 = c_lime
}
if global.creditsmultiplier > 2.99 {
col1 = c_fuchsia
col2 = c_aqua
}

draw_text_color(room_width / 2,y+330,"MULTIPLIER: " + string(global.creditsmultiplier) + "X",col1,col2,col1,col2,1)
