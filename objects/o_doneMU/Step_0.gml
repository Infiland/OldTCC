...
multiplayerhat = global.multiplayerplayerhat[0] break;
case(2): multiplayerskin = global.multiplayerplayerskin[1] 
multiplayerhat = global.multiplayerplayerhat[1] break;
case(3): multiplayerskin = global.multiplayerplayerskin[2]
multiplayerhat = global.multiplayerplayerhat[2] break;
case(4): multiplayerskin = global.multiplayerplayerskin[3]
multiplayerhat = global.multiplayerplayerhat[3] break;
...
if global.skinMUlocked = true || global.hatMUlocked = true { 
	image_index = 0
	image_alpha = 0.5 
	} else { image_alpha = 1 }