...
if instance_exists(o_gravity01LE) || instance_exists(o_gravity05LE) || instance_exists(o_gravity15LE) || instance_exists(o_gravity25LE) || instance_exists(o_gravitylimit01) || instance_exists(o_gravitylimit05) || instance_exists(o_gravitylimit15) || instance_exists(o_gravitylimit25) {
tagArray[i] = "Gravity";
i++
}
...
if instance_exists(o_spikemovingdownup) || instance_exists(o_spikemovingrightleft) || instance_exists(o_spikemovingleftright) || instance_exists(o_spikemovingupdown) {
tagArray[i] = "Vertical Spikes";
i++
}
if instance_exists(o_Hspikemovingup) || instance_exists(o_Hspikemovingdown) || instance_exists(o_Hspikemovingleft) || instance_exists(o_Hspikemovingright) {
...
requestId = steam_ugc_submit_item_update(updateHandle, "Version 1.0");
