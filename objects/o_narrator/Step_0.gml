...
case(r_lvl36): str = strings[48] break;
...
case(r_lvl42): str = strings[56] break;
...
case(r_lvl90): str = strings[136] break;
...
case(r_slipperylvl6): str = strings[130] break;
...
//TUTORIAL
case(r_tutorialchallengelvl1): str = strings[177] break;
case(r_tutorialchallengelvl2): str = strings[178] break;
case(r_tutorialchallengelvl3): str = strings[179] break;
case(r_tutorialchallengelvl4): str = strings[180] break;
case(r_tutorialchallengelvl5): str = strings[181] break;
case(r_tutorialchallengelvl6): str = strings[182] break;
//SPIKE
