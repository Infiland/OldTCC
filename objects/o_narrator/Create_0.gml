...
strings[1] = "W1-L1 You started hard mode, no skipping, limited deaths, harder bosses, good luck."
strings[2] = "W1-L2 By the way, you don't need to hold the jump button, but you can anyway if you need to."
strings[3] = "W1-L2 Also, if you lose all lives, you go all the way back to the beggining."
...
strings[10] = "W1-L6 Interesting..."
strings[11] = "W1-L7 Time for a huge jump!"
strings[12] = "W1-L7 So you are telling me that you played this game before?"
strings[13] = "W1-L8 Ohhhh, what is this?"
strings[14] = "W1-L8 Alright, I guess that you like coins"
strings[15] = "W1-L9 I guess you now know the main mechanic of this game."
strings[16] = "Looks like you really really like coins."
strings[17] = "W1-L10 Just a long level."
strings[18] = "W1-L10 Anyway I'm gonna stop here. Good luck on your Coins% run, I guess."
strings[19] = "W1-L11 Sometimes, you have to think before you play the level."
strings[20] = "W1-L12 I call this 'A lot of yellows 1.0'."
strings[21] = "W1-L13 This is called a 'Climb Jump' and it is quite tricky to succeed. Please have few tries."
strings[22] = "W1-L14 Either you go the easy way, or HARD way..."
strings[23] = "W1-L14 Either you go the easy way, or HARD way... wait, there is no easy way!"
...
strings[26] = "W1-L17 WHAT? Are you telling me there is even MORE GREEN BLOCKS?"
...
strings[35] = "W2-L3 Anyway, here is your first REAL challenge."
strings[36] = "W2-L4 Do you remember when I told you that you should think before you play?"
strings[37] = "W2-L5 What is this purple thing?"
...
strings[41] = "W2-L9 This is probably developers nickname..."
...
strings[65] = "W3-L11 These are the worst spikes in the game. The invinsible spikes, if you are near them, you can\nsee those spikes."
strings[66] = "W3-L12 Here is more portals for you!"
...
strings[72] = "W3-L18 Watch out for those damn invinsible spikes!"
...
strings[80] = "W4-L5 Timing is the key! (Don't forget to skip hard levels using coins)."
strings[81] = "W4-L6 This is why you need coins."
strings[82] = "W4-L7 Pick a door, any door!"
strings[83] = "W4-L8 Call for help."
strings[84] = "W4-L9 Take a break, must have been frustraiting so far without a freebie. If you have been wondering where\nyour journey will ACTUALLY END, well I've came with a friendly reminder that you have 30 levels left to\ngo! I want to encourage you to not lose hope and to beat the king, whatever the cost. Since the following\nlairs of the king are getting way harder from this point. Good luck, hero."
...
strings[98] = "W5-L3 Uh oh, looks like he setup more troops."
strings[99] = "W5-L4 You have to get away from them somehow."
strings[100] = "W5-L5 Cannons never end."
...
strings[185] = "W5-L16 Quickly! Run! Don't read this text! Don't waste your time!"
...
strings[236] = "C.SPIKE-L5 | Hello."
strings[237] = "C.SPIKE-L6 | I am impressed in your skills. But you are far away from mastery."
...
strings[249] = "W7-L8 EXTREME PRECISION AHEAD"
