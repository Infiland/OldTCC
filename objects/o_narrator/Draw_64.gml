...
if global.cheats = 1 {
	if room = r_theend {
	draw_text_color(16,0,string_hash_to_newline("Your time is: " + string(global.time)) + " (This is not the end, since the game is not fully finished.)\nAlso you cheated...",c_red,c_red,c_red,c_red,1)
	}}
if global.cheats = 0 {	
if room = r_theend { draw_text(16,0,string_hash_to_newline("Your time is: " + string(global.time) + " (This is not the end, since the game is not fully finished.)")) }
}
