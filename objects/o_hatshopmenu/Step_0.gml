...
case(32): makehatshop(global.hat032,75,32) break;
//Pirate Hat Icon
case(33): makehatshop(global.hat033,125,33) break;
//Pink Bowtie Hat Icon
case(34): makehatshop(global.hat034,50,34) break;
//King Hat Icon
case(35): makehatshop(global.hat035,499,35) break;
//Hair
case(36): makehatshop(global.hat036,100,36) break;
//Comrade
case(37): makehatshop(global.hat037,250,37) break;
//Viking
case(38): makehatshop(global.hat038,75,38) break;
//Red Sus
case(39): makehatshop(global.hat040,100,40) break;
//Yellow Sus
case(40): makehatshop(global.hat041,75,41) break;
//Green Sus
case(41): makehatshop(global.hat042,75,42) break;
//Blue Sus
case(42): makehatshop(global.hat043,50,43) break;
//White Sus
case(43): makehatshop(global.hat044,75,44) break;
