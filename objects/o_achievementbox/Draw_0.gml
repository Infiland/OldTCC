...
case(46): draw_achievement(s_JumpAIcon2,global.totaljumps,20,0,"The Jumpventure Begins!","Jump 20 Times.",1,0) break;
...
case(79): draw_achievement(s_reverseAIcon,"THE_REVERSE_PROBLEM",1,0,"The Reverse Problem","Beat the game with reversed controls!",0.92,1) break;
