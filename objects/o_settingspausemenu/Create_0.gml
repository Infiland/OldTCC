...
instance_create(camera_get_view_x(view_camera[0])-256,camera_get_view_y(view_camera[0])+480,o_skipintroscreensettings)
instance_create(camera_get_view_x(view_camera[0])-256,camera_get_view_y(view_camera[0])+544,o_antialiasingsettings)
instance_create(camera_get_view_x(view_camera[0])-256,camera_get_view_y(view_camera[0])+608,o_vsyncsettings)
...
var i2 = 0
for (i2=0;i2<6;i2++) {
lang = instance_create(camera_get_view_x(view_camera[0])-256,camera_get_view_y(view_camera[0])+160+64*i2,o_changelanguagesettings)
with lang {
depth = -101
image_xscale = 37.7
image_yscale = 10
