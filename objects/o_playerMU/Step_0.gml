...
if onice = true {
if color < 3 {realwalk = lerp(realwalk,walksp,0.02)}
if color = 3 {realwalk = lerp(realwalk,walksp,0.03)}
if color = 4 {realwalk = lerp(realwalk,walksp,0.015)}
}
if onice = false {
...
if global.gunammoinfinite = false { ammo -= 1 }
}
if ammo < 1 {
...
if !color = 0 or color = 1 or color = 2 or color = 3 {
if place_meeting(x-2,y-2,o_redblock) {
deathMU() }}
if passblockcooldown < 1 {
if !color = 0 or color = 1 or color = 2 or color = 3 {
if place_meeting(x,y,o_redpassblock) {
deathMU() }}}
if passblockcooldown < 1 {
if !color = 1 or color = 0 or color = 2 or color = 3 {
if place_meeting(x,y,o_yellowpassblock) {
deathMU() }}}
if passblockcooldown < 1 {
if !color = 2 or color = 0 or color = 1 or color = 3 {
if place_meeting(x,y,o_greenpassblock) {
deathMU() }}}
if passblockcooldown < 1 {
if !color = 3 or color = 0 or color = 1 or color = 2 {
if place_meeting(x,y,o_bluepassblock) {
deathMU() }}}
if !color = 0 or color = 1 or color = 2 or color = 3 {
if place_meeting(x-10,y-10,o_redblockmove) {
deathMU() }}

if !color = 1 or color = 0 or color = 2 or color = 3 {
if place_meeting(x-10,y-10,o_yellowblockmove) {
deathMU() }}

if !color = 2 or color = 0 or color = 1 or color = 3 {
if place_meeting(x-10,y-10,o_greenblockmove) {
deathMU() }}

if !color = 3 or color = 0 or color = 1 or color = 2 {
if place_meeting(x-10,y-10,o_blueblockmove) {
deathMU() }}
if !color = 1 or color = 0 or color = 2 or color = 3 {
...
deathMU() }}
if !color = 3 or color = 0 or color = 1 or color = 2 {
if place_meeting(x-1,y-1,o_blueblock) {
deathMU() }}
if !color = 0 or color = 1 or color = 2 or color = 3 {
...
if !color = 0 or color = 1 or color = 2 or color = 3 {
if place_meeting(x+1,y+1,o_redblockmove) {
deathMU() }}

if !color = 1 or color = 0 or color = 2 or color = 3 {
if place_meeting(x+1,y+1,o_yellowblockmove) {
deathMU() }}

if !color = 2 or color = 0 or color = 1 or color = 3 {
if place_meeting(x+1,y+1,o_greenblockmove) {
deathMU() }}

if !color = 3 or color = 0 or color = 1 or color = 2 {
if place_meeting(x+1,y+1,o_blueblockmove) {
deathMU() }}
if !color = 1 or color = 0 or color = 2 or color = 3 {
if place_meeting(x+1,y+1,o_yellowblock) {
deathMU() }}
