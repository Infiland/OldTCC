...
break;
case(4): draw_sprite(s_paperhat,0,x+16,y+6) break;
case(5): draw_sprite(s_tophat,0,x+16,y+8)
break;
case(6): draw_sprite(s_yellowtophat,0,x+16,y+8)
break;
case(7):
switch(color) {
...
break;
case(8): draw_sprite(s_santahat,0,x+16,y+8) break;
case(9): draw_sprite(s_witchhat,0,x+16,y+8) break;
case(10): draw_sprite(s_pumpkinhat,0,x+16,y+8) break;
case(11): draw_sprite(s_brownhat,0,x+16,y+8) break;
case(12): draw_sprite(s_grayhat,0,x+16,y+8) break;
case(13): draw_sprite(s_whitehat,0,x+16,y+8) break;
case(14): draw_sprite(s_sunhat,0,x+16,y+8) break;
case(15): draw_sprite(s_redblockhat,0,x+16,y+8) break;
case(16): draw_sprite(s_yellowblockhat,0,x+16,y+8) break;
case(17): draw_sprite(s_greenblockhat,0,x+16,y+8) break;
case(18): draw_sprite(s_blueblockhat,0,x+16,y+8) break;
case(19): draw_sprite(s_whiteblockhat,0,x+16,y+8) break;
case(20): draw_sprite(s_spikehat,0,x+16,y+8) break;
case(21):
var spikehatalpha = random_range(0.5,1)
draw_sprite_ext(s_spikehat,0,x+16,y+8,1,1,0,c_white,spikehatalpha) break;
case(22): draw_sprite_ext(s_spikehat,0,x+16,y+8,1,1,0,c_lime,1) break;
case(23): draw_sprite_ext(s_spikehat,0,x+16,y+8,1,1,0,c_yellow,1) break;
case(24): draw_sprite(s_hexagonhat,0,x+16,y+8) break;
case(25): draw_sprite(s_breadhat,0,x+16,y+8) break;
case(26): draw_sprite_ext(s_soldierhat,0,x+16,y+8,1.2,1,0,c_white,1) break;
case(27): draw_sprite(s_samuraihat,0,x+16,y+8) break;
