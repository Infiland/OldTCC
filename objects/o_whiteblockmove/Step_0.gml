...
if (place_meeting(x+hsp,y,o_blueblock)) {
		while(!place_meeting(x+sign(hsp),y,o_blueblock)) {
        x += sign(hsp)	
		}
		hsp = 0;
		dir *= -1
}
if (place_meeting(x+hsp,y,o_whiteblock)) {
		while(!place_meeting(x+sign(hsp),y,o_whiteblock)) {
        x += sign(hsp)	
		}
		hsp = 0;
		dir *= -1
