...
draw_text(30,390 - yscroll,ENDLESSRUNHIGHSCORE + string(global.newendlesslevelhighscore))
draw_text(30,410 - yscroll,OSENDLESSRUNHIGHSCORE + string(global.endlesslevelhighscore))
draw_text(30,430 - yscroll,GUNSHOTS + string(global.totalgunshots))
draw_text(30,450 - yscroll,GUNPICKUPS + string(global.totalgunpickups))
draw_text(30,470 - yscroll,AMMOPICKUPS + string(global.totalammopickups))
draw_text(30,490 - yscroll,DESTROYEDBOXES + string(global.totaldestroyedboxes))
draw_text(30,510 - yscroll,ENEMYKILLS + string(global.totalenemykills))
draw_text(30,530 - yscroll,ONEUPSCOLLECTED + string(global.total1ups))
draw_text(30,550 - yscroll,ROCKETSDESTROYED + string(global.totalrocketkills))
draw_text(30,570 - yscroll,OXYGENPICKUPS + string(global.totaloxygenpickups))
draw_text(30,590 - yscroll,DOUBLEJUMPPICKUPS + string(global.totaldjumppickups))

draw_text_color(30,630 - yscroll,DEATHS,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,650 - yscroll,TOTALDEATHS + string(global.totaldeaths))
draw_text(30,670 - yscroll,BLOCKDEATHS + string(global.totalblockdeaths))
draw_text(30,690 - yscroll,RESTARTDEATHS + string(global.totalrestartdeaths))
draw_text(30,710 - yscroll,SPIKEDEATHS + string(global.totalspikedeaths))
draw_text(30,730 - yscroll,INVSPIKEDEATHS + string(global.totalinvisiblespikedeaths))
draw_text(30,750 - yscroll,VMOVINGSPIKEDEATHS + string(global.totalverticalspikedeaths))
draw_text(30,770 - yscroll,HMOVINGSPIKEDEATHS + string(global.totalhorizontalspikedeaths))
draw_text(30,790 - yscroll,GOLDENSPIKEDEATHS + string(global.totalgoldspikedeaths))
draw_text(30,810 - yscroll,WEIRDSPIKEDEATHS + string(global.totalweirdspikedeaths))
draw_text(30,830 - yscroll,VOIDDEATHS + string(global.totalvoiddeaths))
draw_text(30,850 - yscroll,SETONFIRE + string(global.totalfiredeaths))
draw_text(30,870 - yscroll,LAVADEATHS + string(global.totallavadeaths))
draw_text(30,890 - yscroll,BULLETDEATHS + string(global.totalbulletdeaths))
draw_text(30,910 - yscroll,ROCKETDEATHS + string(global.totalrocketdeaths))
draw_text(30,930 - yscroll,TROOPDEATHS + string(global.totaltroopdeaths))
draw_text(30,950 - yscroll,DROWNED + string(global.totalwaterdeaths))

draw_text_color(30,990 - yscroll,AVERAGES,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,1010 - yscroll,AVERAGEDEATHSPERLEVEL + string(global.totaldeaths / global.totallevelcompleted))
draw_text(30,1030 - yscroll,AVERAGETIMEPERLEVEL + string((global.totaltime / 60) / global.totallevelcompleted) + "m")	

draw_text_color(30,1070 - yscroll,PROGRESSION,c_yellow,c_orange,c_yellow,c_orange,1)
draw_text(30,1090 - yscroll,NORMALSKINSUNLOCKED + string(normalskins) + "/" + string(reqnormalskins) + " (" + string(normalskinspercentage) + "%)")
draw_text(30,1110 - yscroll,LEGENDARYSKINSUNLOCKED + string(legskins) + "/" + string(reqlegskins) + " (" + string(legskinspercentage) + "%)")
draw_text(30,1130 - yscroll,HATSACQUIRED + string(allhats) + "/" + string(reqallhats) + " (" + string(hatspercentage) + "%)")
if global.hardmodeunlock != 0 {
draw_text(30,1150 - yscroll,HARDMODEDIFFICULTIESBEATEN + string(HMprogress) + "/" + string(reqHM) + " (" + string(HMpercentage) + "%)")
} else { draw_text(30,1150 - yscroll,HARDMODEDIFFICULTIESBEATEN + " 0/7") }
draw_text(30,1170 - yscroll,CHALLENGESBEATEN + string(Cprogress) + "/" + string(reqchallenge) + " (" + string(challengepercenntage) + "%)")
draw_text(30,1190 - yscroll,PERFECTCHALLENGESBEATEN + string(perfectchallenge) + "/" + string(reqperfectchallenge) + " (" + string(perfectchallengepercentage) + "%)")
draw_text(30,1210 - yscroll,WORLDSCOMPLETED + string(Wprogress) + "/" + string(reqW) + " (" + string(Wpercentage) + "%)")
draw_text(30,1230 - yscroll,TOTALACHIEVEMENTS + string(allach) + "/" + string(reqach) + " (" + string(achpercentage) + "%)")

draw_text_color(30,1270 - yscroll,FULLGAMECOMPLETION + string(gameprogress) + "%",c_yellow,c_orange,c_yellow,c_orange,1)
...
if everything > 2500000 { rank = 27} //Dedicated Happy Athlete
...
default: draw_text(30,700,string(RANKL) + "dha") break;
}