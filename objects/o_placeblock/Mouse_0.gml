...
case(51): 
	...
	instance_create(x,y,o_blockcheck2)
	break;
case(52): instance_create(x,y,o_onewayleftblock)
instance_create(x,y,o_blockcheck2) break;
...
case(87): instance_create(x,y,o_redblockbreakableLE) break;
case(88): instance_create(x,y,o_yellowblockbreakableLE) break;
case(89): instance_create(x,y,o_greenblockbreakableLE) break;
case(90): instance_create(x,y,o_blueblockbreakableLE) break;
case(91): instance_create(x,y,o_whiteblockbreakableLE) break;
}
}
if global.LEBuild = 2 {
